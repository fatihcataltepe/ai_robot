...
public class Visualiser {
   ...
   private void createComponents() {
      ...
      wp.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(5, 10, 10, 10),
   ...
   private void createFileMenu() {
      ...
      fileMenu.getAccessibleContext().setAccessibleDescription("Load configs or close the app.");
   ...
   private void createDisplayMenu() {
      ...
      fileMenu.getAccessibleContext().setAccessibleDescription("Display the problem and solution.");
   ...
   private void createAnimationMenu() {
      ...
      fileMenu.getAccessibleContext().setAccessibleDescription("Manage the animation.");
   ...
   private void showFileError(File f) {
      JOptionPane.showMessageDialog(container, "Error loading " + f.getName(), "File I/O Error", JOptionPane.ERROR_MESSAGE);
   }
   ...
   private void setInfoText() {
      if (!hasProblem) {
         ...
         infoLabel.setText("Displaying the problem: blue = initial, green = goal, red = obstacle. Base is circled.");
         samplingSpinner.setVisible(false);
      }
   }
